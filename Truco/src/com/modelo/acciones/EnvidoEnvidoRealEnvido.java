...
public class EnvidoEnvidoRealEnvido extends Accion {
	public EnvidoEnvidoRealEnvido() {
		this.puntosQueOtorgaSiSeQuiere = 7;
		this.puntosQueOtorgaSiNoSeQuiere = 4;
		this.proximasAccionesPosibles = Arrays.asList("EnvidoEnvidoRealEnvidoFaltaEnvido", "JuegoLibre");
	}
