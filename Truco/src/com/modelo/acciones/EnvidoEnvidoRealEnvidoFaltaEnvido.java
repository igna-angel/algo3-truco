...
public class EnvidoEnvidoRealEnvidoFaltaEnvido extends Accion {
	public EnvidoEnvidoRealEnvidoFaltaEnvido() {
		this.puntosQueOtorgaSiSeQuiere = -1;
		this.puntosQueOtorgaSiNoSeQuiere = 5;
		this.proximasAccionesPosibles = Arrays.asList("JuegoLibre");
	}
